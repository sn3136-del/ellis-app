      ...
      <div>
        ...
        <div className="trip-home" data-testid="hero">
          ...
          <div className="trip-home__lanes" data-testid="product-lanes">
            {/* US travel-visas lane hidden by owner decision (theming,
                2026-08-19): the evaluation presents Germany only. Nothing
                removed — the journey, released adapter and hashes remain. */}
            {false && (
            ...
            <div className="trip-lane trip-lane--tall card-hover anim-rise-2" data-testid="lane-h1b-employer">
              ...
              <div className="trip-lane__ctas">
                <button className="trip-cta trip-cta--sm"
                  ...
                  {t('start.lane.h1b.cta')}{arrow}
                </button>
              </div>
            </div>
            <div className="trip-lane trip-lane--tall card-hover anim-rise-3" data-testid="lane-h1b-worker">
