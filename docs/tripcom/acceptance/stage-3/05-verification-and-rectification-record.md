# Stage 3 verification and rectification record 验证与整改记录
...
Open items not yet published at generation time: **250**.
Items open beyond the 48 hour closure window: **78**.
